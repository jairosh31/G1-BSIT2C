...
$error = "";
try {
    $stmt = $conn->query("SELECT id, username, email, role, created_at FROM users ORDER BY created_at ASC, id ASC");
...
<head>
    ...
    <style>
        ...
        /* Hard override for readable users table text */
    ...
    <div class="booking-main">
        <div class="container py-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h3 class="mb-0 text-white" style="color: #ffffff !important;">All users</h3>
                <div class="d-flex gap-2">
                    <a href="admin_create_user.php" class="btn btn-primary btn-sm">Create account</a>
