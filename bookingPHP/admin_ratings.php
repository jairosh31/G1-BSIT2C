...
try {
    $stmt = $conn->query("
        SELECT r.id, r.user_id, r.source, r.rating, r.comment, r.created_at,
               u.username, u.email
        FROM ratings r
    ...
    $error = "Error loading ratings: " . htmlspecialchars($e->getMessage());
    $ratings = [];
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        /* Hard override for readable ratings table text */
    ...
    <div class="booking-main">
        <div class="container py-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h3 class="mb-0 text-white" style="color: #ffffff !important;">All ratings</h3>
            ...
            <table class="table table-striped table-hover align-middle">
                ...
                <?php foreach ($ratings as $r): ?>
                    <tr>
                        ...
                        <td><span class="badge bg-info text-dark"><?php echo htmlspecialchars($r['source']); ?></span></td>
                        <td>
                            <?php
